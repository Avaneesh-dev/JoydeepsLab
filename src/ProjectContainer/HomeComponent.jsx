      ...
      <div className="vh-75">
        <div className='row col-12 d-flex justify-content-center align-items-center' style={{position: "absolute", zIndex: 10, marginTop:"70px"}}>
          <div className='col-11 col-md-2'>
            <img src='./LTB-Logo.png' className="img-fluid" alt="Lab's logo" />
          </div>
          <div className='d-none d-md-block col-10 col-md-7 text-center'><h1 style={{color:"white", fontSize: 30, fontFamily: "fantasy"}}>Welcome To The Laboratory of Transgenic Botany<br />
      ...
      <div className='home'>
        ...
        <div className='row mt-5'>
          ...
          <div className="col-md-9 text-start">
            <p className='h2 fw-bold'>Latest Technology for Cutting Edge Research</p>
            {/* <p className='h6 text-muted'>Associate Professor<br />Department of Agricultural and Food Engineering,<br /> Indian Institute of Technology Kharagpur</p> */}
